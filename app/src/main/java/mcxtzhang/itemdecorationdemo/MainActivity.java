...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(30, ViewGroup.LayoutParams.WRAP_CONTENT);
        mIndexBar.setLayoutParams(params);
        ll.addView(mIndexBar);
